...
- **artifact-bin** — Publish self-contained HTML artifacts (reports, dashboards, slides, datasets, charts, images) to artifact-bin and share the public link. Details: [plugins/artifact-bin/README.md](plugins/artifact-bin/README.md)
