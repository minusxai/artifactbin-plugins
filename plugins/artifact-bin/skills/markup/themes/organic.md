# theme: organic — Organic

Warm, soft, playful — sage green, terracotta, leafy chart tones; Fraunces display over Figtree, extra-round corners.
...
architectural — sections breathe into each other.
